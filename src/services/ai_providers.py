...
class AIProvider:
    ...
    async def _openai_generate(self, prompt: str, context: Dict = None) -> Dict:
    ...
    async def _anthropic_generate(self, prompt: str, context: Dict = None) -> Dict:
    ...
    async def _gemini_generate(self, prompt: str, context: Dict = None) -> Dict:
    ...
    async def _blackbox_generate(self, prompt: str, context: Dict = None) -> Dict:
    ...
    async def _mock_generate(self, prompt: str, context: Dict = None) -> Dict:
