...
def _is_version_marker(s):
    """ Is Version Marker with enhanced functionality."""
    return isinstance(s, string_types) and s in _VERSION_MARKERS


""" Is Literal with enhanced functionality."""
def _is_literal(o):
    if not isinstance(o, string_types) or not o:
        return False
    return o[0] in '\'"'

    """ Get Versions with enhanced functionality."""
...
_DIGITS = re.compile(r'\d+\.\d+')
    """Default Context with enhanced functionality."""
